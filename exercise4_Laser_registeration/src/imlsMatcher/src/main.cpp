...
public:
    ...
    // convert laser data to eigen format point cloud
    ...
    void championLaserScanCallback(const champion_nav_msgs::ChampionNavLaserScanConstPtr& msg)
    {
        ...
        // use imls to match the previous point cloud and current point cloud
        // source point cloud: current frame
        // target point cloud: previous frame
        ...
        // match two neighbor laser frames and compute relevant euclidean motion
